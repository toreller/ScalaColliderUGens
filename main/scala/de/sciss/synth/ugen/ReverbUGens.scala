...
final case class FreeVerb(in: GE, mix: GE, room: GE, damp: GE) extends UGenSource.SingleOut {
...
final case class FreeVerb2(left: GE, right: GE, mix: GE, room: GE, damp: GE) extends UGenSource.MultiOut {
...
final case class GVerb(in: GE, roomSize: GE, revTime: GE, damping: GE, inputBW: GE, spread: GE, dryLevel: GE, earlyRefLevel: GE, tailLevel: GE, maxRoomSize: GE) extends UGenSource.MultiOut {
