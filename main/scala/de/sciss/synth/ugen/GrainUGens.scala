 ...
 * '''Warning''': The argument order is different from its sclang counterpart.
 */
final case class GrainIn(in: GE, numChannels: Int, trig: GE, dur: GE, pan: GE, envBuf: GE, maxGrains: GE) extends UGenSource.MultiOut("GrainIn", numChannels) with AudioRated {
...
final case class GrainSin(numChannels: Int, trig: GE, dur: GE, freq: GE, pan: GE, envBuf: GE, maxGrains: GE) extends UGenSource.MultiOut("GrainSin", numChannels) with AudioRated {
...
final case class GrainFM(numChannels: Int, trig: GE, dur: GE, carFreq: GE, modFreq: GE, index: GE, pan: GE, envBuf: GE, maxGrains: GE) extends UGenSource.MultiOut("GrainFM", numChannels) with AudioRated {
 ...
 * '''Warning''': The argument order is different from its sclang counterpart.
 */
final case class GrainBuf(buf: GE, numChannels: Int, trig: GE, dur: GE, speed: GE, pos: GE, pan: GE, envBuf: GE, maxGrains: GE) extends UGenSource.MultiOut("GrainBuf", numChannels) with AudioRated {
...
final case class Warp1(numChannels: Int, buf: GE, pos: GE, speed: GE, winSize: GE, envBuf: GE, overlaps: GE, winRand: GE, interp: GE) extends UGenSource.MultiOut("Warp1", numChannels) with AudioRated {
