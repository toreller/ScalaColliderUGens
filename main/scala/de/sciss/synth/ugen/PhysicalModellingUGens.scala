...
final case class Spring(rate: Rate, in: GE, spring: GE, damp: GE) extends UGenSource.SingleOut {
...
final case class Ball(rate: Rate, in: GE, g: GE, damp: GE, friction: GE) extends UGenSource.SingleOut {
...
final case class TBall(rate: Rate, in: GE, g: GE, damp: GE, friction: GE) extends UGenSource.SingleOut {
   protected def makeUGens: UGenInLike = unwrap(IIdxSeq(in.expand, g.expand, damp.expand, friction.expand))
