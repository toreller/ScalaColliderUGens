 ...
 * Created: Thu Jan 06 16:40:57 GMT 2011
...
case class Ramp[R <: Rate](rate: R, in: AnyGE, dur: AnyGE) extends GE[R, RampUGen[R]] {
   def expand = {
...
case class Lag[R <: Rate](rate: R, in: AnyGE, time: AnyGE) extends GE[R, LagUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
...
case class Lag2[R <: Rate](rate: R, in: AnyGE, time: AnyGE) extends GE[R, Lag2UGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _time: IIdxSeq[AnyUGenIn] = time.expand
      val _sz_in = _in.size
...
case class Lag3[R <: Rate](rate: R, in: AnyGE, time: AnyGE) extends GE[R, Lag3UGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _time: IIdxSeq[AnyUGenIn] = time.expand
      val _sz_in = _in.size
...
case class LagUD[R <: Rate](rate: R, in: AnyGE, timeUp: AnyGE, timeDown: AnyGE) extends GE[R, LagUDUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
...
case class Lag2UD[R <: Rate](rate: R, in: AnyGE, timeUp: AnyGE, timeDown: AnyGE) extends GE[R, Lag2UDUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _timeUp: IIdxSeq[AnyUGenIn] = timeUp.expand
      val _timeDown: IIdxSeq[AnyUGenIn] = timeDown.expand
...
case class Lag3UD[R <: Rate](rate: R, in: AnyGE, timeUp: AnyGE, timeDown: AnyGE) extends GE[R, Lag3UDUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _timeUp: IIdxSeq[AnyUGenIn] = timeUp.expand
      val _timeDown: IIdxSeq[AnyUGenIn] = timeDown.expand
...
case class OnePole[R <: Rate](rate: R, in: AnyGE, coeff: AnyGE) extends GE[R, OnePoleUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
...
case class OneZero[R <: Rate](rate: R, in: AnyGE, coeff: AnyGE) extends GE[R, OneZeroUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _coeff: IIdxSeq[AnyUGenIn] = coeff.expand
      val _sz_in = _in.size
...
case class TwoPole[R <: Rate](rate: R, in: AnyGE, freq: AnyGE, radius: AnyGE) extends GE[R, TwoPoleUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
...
case class TwoZero[R <: Rate](rate: R, in: AnyGE, freq: AnyGE, radius: AnyGE) extends GE[R, TwoZeroUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _freq: IIdxSeq[AnyUGenIn] = freq.expand
      val _radius: IIdxSeq[AnyUGenIn] = radius.expand
...
case class Decay[R <: Rate](rate: R, in: AnyGE, time: AnyGE) extends GE[R, DecayUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _time: IIdxSeq[AnyUGenIn] = time.expand
      val _sz_in = _in.size
...
case class Decay2[R <: Rate](rate: R, in: AnyGE, attack: AnyGE, release: AnyGE) extends GE[R, Decay2UGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
...
case class Delay1[R <: Rate](rate: R, in: AnyGE) extends GE[R, Delay1UGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
...
case class Delay2[R <: Rate](rate: R, in: AnyGE) extends GE[R, Delay2UGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
...
case class Integrator[R <: Rate](rate: R, in: AnyGE, coeff: AnyGE) extends GE[R, IntegratorUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _coeff: IIdxSeq[AnyUGenIn] = coeff.expand
      val _sz_in = _in.size
...
case class LeakDC[R <: Rate](rate: R, in: AnyGE, coeff: AnyGE) extends GE[R, LeakDCUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _coeff: IIdxSeq[AnyUGenIn] = coeff.expand
      val _sz_in = _in.size
...
case class LPZ1[R <: Rate](rate: R, in: AnyGE) extends GE[R, LPZ1UGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
...
case class HPZ1[R <: Rate](rate: R, in: AnyGE) extends GE[R, HPZ1UGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
...
case class LPZ2[R <: Rate](rate: R, in: AnyGE) extends GE[R, LPZ2UGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
...
case class HPZ2[R <: Rate](rate: R, in: AnyGE) extends GE[R, HPZ2UGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
...
case class BPZ2[R <: Rate](rate: R, in: AnyGE) extends GE[R, BPZ2UGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
...
case class BRZ2[R <: Rate](rate: R, in: AnyGE) extends GE[R, BRZ2UGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
...
case class APF[R <: Rate](rate: R, in: AnyGE, freq: AnyGE, radius: AnyGE) extends GE[R, APFUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _freq: IIdxSeq[AnyUGenIn] = freq.expand
      val _radius: IIdxSeq[AnyUGenIn] = radius.expand
...
case class LPF[R <: Rate](rate: R, in: AnyGE, freq: AnyGE) extends GE[R, LPFUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _freq: IIdxSeq[AnyUGenIn] = freq.expand
      val _sz_in = _in.size
...
case class HPF[R <: Rate](rate: R, in: AnyGE, freq: AnyGE) extends GE[R, HPFUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _freq: IIdxSeq[AnyUGenIn] = freq.expand
      val _sz_in = _in.size
...
case class BPF[R <: Rate](rate: R, in: AnyGE, freq: AnyGE, rq: AnyGE) extends GE[R, BPFUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _freq: IIdxSeq[AnyUGenIn] = freq.expand
...
case class BRF[R <: Rate](rate: R, in: AnyGE, freq: AnyGE, rq: AnyGE) extends GE[R, BRFUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _freq: IIdxSeq[AnyUGenIn] = freq.expand
      val _rq: IIdxSeq[AnyUGenIn] = rq.expand
...
case class RLPF[R <: Rate](rate: R, in: AnyGE, freq: AnyGE, rq: AnyGE) extends GE[R, RLPFUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _freq: IIdxSeq[AnyUGenIn] = freq.expand
      val _rq: IIdxSeq[AnyUGenIn] = rq.expand
...
case class RHPF[R <: Rate](rate: R, in: AnyGE, freq: AnyGE, rq: AnyGE) extends GE[R, RHPFUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _freq: IIdxSeq[AnyUGenIn] = freq.expand
      val _rq: IIdxSeq[AnyUGenIn] = rq.expand
...
case class Slew[R <: Rate](rate: R, in: AnyGE, up: AnyGE, down: AnyGE) extends GE[R, SlewUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
...
case class Slope[R <: Rate](rate: R, in: AnyGE) extends GE[R, SlopeUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
...
case class MidEQ[R <: Rate](rate: R, in: AnyGE, freq: AnyGE, rq: AnyGE, gain: AnyGE) extends GE[R, MidEQUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _freq: IIdxSeq[AnyUGenIn] = freq.expand
      val _rq: IIdxSeq[AnyUGenIn] = rq.expand
...
case class Median[R <: Rate](rate: R, in: AnyGE, length: AnyGE) extends GE[R, MedianUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
...
case class Resonz[R <: Rate](rate: R, in: AnyGE, freq: AnyGE, rq: AnyGE) extends GE[R, ResonzUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _freq: IIdxSeq[AnyUGenIn] = freq.expand
      val _rq: IIdxSeq[AnyUGenIn] = rq.expand
...
case class Ringz[R <: Rate](rate: R, in: AnyGE, freq: AnyGE, attack: AnyGE, decay: AnyGE) extends GE[R, RingzUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _freq: IIdxSeq[AnyUGenIn] = freq.expand
      val _attack: IIdxSeq[AnyUGenIn] = attack.expand
...
case class Formlet[R <: Rate](rate: R, in: AnyGE, freq: AnyGE, attack: AnyGE, decay: AnyGE) extends GE[R, FormletUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _freq: IIdxSeq[AnyUGenIn] = freq.expand
      val _attack: IIdxSeq[AnyUGenIn] = attack.expand
...
case class FOS[R <: Rate](rate: R, in: AnyGE, a0: AnyGE, a1: AnyGE, b1: AnyGE) extends GE[R, FOSUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
...
case class SOS[R <: Rate](rate: R, in: AnyGE, a0: AnyGE, a1: AnyGE, a2: AnyGE, b1: AnyGE, b2: AnyGE) extends GE[R, SOSUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _a0: IIdxSeq[AnyUGenIn] = a0.expand
      val _a1: IIdxSeq[AnyUGenIn] = a1.expand
...
case class Compander[R <: Rate](rate: R, in: AnyGE, ctrl: AnyGE, thresh: AnyGE, ratioBelow: AnyGE, ratioAbove: AnyGE, attack: AnyGE, release: AnyGE) extends GE[R, CompanderUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
...
case class Limiter[R <: Rate](rate: R, in: AnyGE, level: AnyGE, dur: AnyGE) extends GE[R, LimiterUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
...
case class Normalizer[R <: Rate](rate: R, in: AnyGE, level: AnyGE, dur: AnyGE) extends GE[R, NormalizerUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _level: IIdxSeq[AnyUGenIn] = level.expand
      val _dur: IIdxSeq[AnyUGenIn] = dur.expand
...
case class Amplitude[R <: Rate](rate: R, in: AnyGE, attack: AnyGE, release: AnyGE) extends GE[R, AmplitudeUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _attack: IIdxSeq[AnyUGenIn] = attack.expand
      val _release: IIdxSeq[AnyUGenIn] = release.expand
...
case class Hilbert[R <: Rate](rate: R, in: AnyGE) extends Expands[HilbertUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
...
case class FreqShift[R <: Rate](rate: R, in: AnyGE, freq: AnyGE, phase: AnyGE) extends GE[R, FreqShiftUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _freq: IIdxSeq[AnyUGenIn] = freq.expand
...
case class MoogFF[R <: Rate](rate: R, in: AnyGE, freq: AnyGE, gain: AnyGE, reset: AnyGE) extends GE[R, MoogFFUGen[R]] {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _freq: IIdxSeq[AnyUGenIn] = freq.expand
      val _gain: IIdxSeq[AnyUGenIn] = gain.expand
...
case class BLowPass(in: AnyGE, freq: AnyGE, rq: AnyGE) extends GE[audio, BLowPassUGen] with AudioRated {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _freq: IIdxSeq[AnyUGenIn] = freq.expand
      val _rq: IIdxSeq[AnyUGenIn] = rq.expand
...
case class BHiPass(in: AnyGE, freq: AnyGE, rq: AnyGE) extends GE[audio, BHiPassUGen] with AudioRated {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _freq: IIdxSeq[AnyUGenIn] = freq.expand
      val _rq: IIdxSeq[AnyUGenIn] = rq.expand
...
case class BBandPass(in: AnyGE, freq: AnyGE, bw: AnyGE) extends GE[audio, BBandPassUGen] with AudioRated {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _freq: IIdxSeq[AnyUGenIn] = freq.expand
...
case class BBandStop(in: AnyGE, freq: AnyGE, bw: AnyGE) extends GE[audio, BBandStopUGen] with AudioRated {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _freq: IIdxSeq[AnyUGenIn] = freq.expand
      val _bw: IIdxSeq[AnyUGenIn] = bw.expand
...
case class BPeakEQ(in: AnyGE, freq: AnyGE, rq: AnyGE, gain: AnyGE) extends GE[audio, BPeakEQUGen] with AudioRated {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _freq: IIdxSeq[AnyUGenIn] = freq.expand
      val _rq: IIdxSeq[AnyUGenIn] = rq.expand
...
case class BAllPass(in: AnyGE, freq: AnyGE, rq: AnyGE) extends GE[audio, BAllPassUGen] with AudioRated {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _freq: IIdxSeq[AnyUGenIn] = freq.expand
      val _rq: IIdxSeq[AnyUGenIn] = rq.expand
...
case class BLowShelf(in: AnyGE, freq: AnyGE, rs: AnyGE, gain: AnyGE) extends GE[audio, BLowShelfUGen] with AudioRated {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _freq: IIdxSeq[AnyUGenIn] = freq.expand
...
case class BHiShelf(in: AnyGE, freq: AnyGE, rs: AnyGE, gain: AnyGE) extends GE[audio, BHiShelfUGen] with AudioRated {
   def expand = {
      val _in: IIdxSeq[AnyUGenIn] = in.expand
      val _freq: IIdxSeq[AnyUGenIn] = freq.expand
      val _rs: IIdxSeq[AnyUGenIn] = rs.expand
