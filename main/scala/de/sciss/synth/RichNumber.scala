...
//      import RichDouble._
   ...
   //   def +[ S <: Rate, T <: Rate ]( b: GE[ S ])( implicit r: MaybeRateOrder[ R, S, T ]) = binOp( Plus, b )
      ...
      def |[ R <: Rate ]( b: GE[ R ]) : GE[ R ]          = cn.|( b )
      def ^[ R <: Rate ]( b: GE[ R ]) : GE[ R ]          = cn.^( b )
      def atan2[ R <: Rate ]( b: GE[ R ]) : GE[ R ]      = cn.atan2( b )
      def hypot[ R <: Rate ]( b: GE[ R ]) : GE[ R ]      = cn.hypot( b )
      def hypotx[ R <: Rate ]( b: GE[ R ]) : GE[ R ]     = cn.hypotx( b )
      def pow[ R <: Rate ]( b: GE[ R ]) : GE[ R ]        = cn.pow( b )
      def ring1[ R <: Rate ]( b: GE[ R ]) : GE[ R ]      = cn.ring1( b )
      def ring2[ R <: Rate ]( b: GE[ R ]) : GE[ R ]      = cn.ring2( b )
      def ring3[ R <: Rate ]( b: GE[ R ]) : GE[ R ]      = cn.ring3( b )
      def ring4[ R <: Rate ]( b: GE[ R ]) : GE[ R ]      = cn.ring4( b )
      def difsqr[ R <: Rate ]( b: GE[ R ]) : GE[ R ]     = cn.difsqr( b )
      def sumsqr[ R <: Rate ]( b: GE[ R ]) : GE[ R ]     = cn.sumsqr( b )
      def sqrsum[ R <: Rate ]( b: GE[ R ]) : GE[ R ]     = cn.sqrsum( b )
      def sqrdif[ R <: Rate ]( b: GE[ R ]) : GE[ R ]     = cn.sqrdif( b )
      def absdif[ R <: Rate ]( b: GE[ R ]) : GE[ R ]     = cn.absdif( b )
      def thresh[ R <: Rate ]( b: GE[ R ]) : GE[ R ]     = cn.thresh( b )
      def amclip[ R <: Rate ]( b: GE[ R ]) : GE[ R ]     = cn.amclip( b )
      def scaleneg[ R <: Rate ]( b: GE[ R ]) : GE[ R ]   = cn.scaleneg( b )
      def clip2[ R <: Rate ]( b: GE[ R ]) : GE[ R ]      = cn.clip2( b )
      def excess[ R <: Rate ]( b: GE[ R ]) : GE[ R ]     = cn.excess( b )
      def fold2[ R <: Rate ]( b: GE[ R ]) : GE[ R ]      = cn.fold2( b )
      def wrap2[ R <: Rate ]( b: GE[ R ]) : GE[ R ]      = cn.wrap2( b )
   //   error( "CURRENTLY DISABLED IN SYNTHETIC UGENS BRANCH" )
   //   def firstarg[ R <: Rate ]( b: GE[ R ]) : GE[ R ]          = cn.firstarg( b )
   ...
   sealed trait NAryGEOps2 extends NAryGEOps {
      def round[ R <: Rate ]( b: GE[ R ]) : GE[ R ]   = cn.round( b )
      def roundup[ R <: Rate ]( b: GE[ R ]) : GE[ R ] = cn.roundup( b )
      def trunc[ R <: Rate ]( b: GE[ R ]) : GE[ R ]   = cn.trunc( b )
   }
}
